...
typedef struct nni_zephyr_pfd nni_zephyr_pfd;
typedef void (*nni_zephyr_pfd_cb)(nni_zephyr_pfd *, unsigned, void *);

extern int  nni_zephyr_pfd_init(nni_zephyr_pfd **, int);
extern void nni_zephyr_pfd_fini(nni_zephyr_pfd *);
extern int  nni_zephyr_pfd_arm(nni_zephyr_pfd *, unsigned);
extern int  nni_zephyr_pfd_fd(nni_zephyr_pfd *);
extern void nni_zephyr_pfd_close(nni_zephyr_pfd *);
extern void nni_zephyr_pfd_set_cb(nni_zephyr_pfd *, nni_zephyr_pfd_cb, void *);
