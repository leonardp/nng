...
//	This value may be ignored on platforms that don't use ZEPHYR clocks.
//
...
//	is defined.  Platforms that don't use ZEPHYR clocks will probably
...
#else
// fallback to poll(2)
#define NNG_USE_ZEPHYR_POLLQ_POLL 1
#endif
#define NNG_USE_ZEPHYR_RESOLV_GAI 1
