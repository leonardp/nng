...
#ifdef NNG_USE_ZEPHYR_RESOLV_GAI
...
int
nni_zephyr_resolv_sysinit(void)
{
...
void
nni_zephyr_resolv_sysfini(void)
{
	nni_mtx_lock(&resolv_mtx);
	resolv_fini = true;
...
#endif // NNG_USE_ZEPHYR_RESOLV_GAI
